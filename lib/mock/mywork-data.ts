...
export const mockTalentProfiles: Record<string, TalentProfile> = {
    ...
    'client7': {
        id: 'client7',
        name: 'GameStudio X',
        avatar: 'https://i.pravatar.cc/150?u=gsx',
        rating: 4.9,
        completedGigs: 0,
        badges: ['VISIONARY'],
        rank: 'G.O.A.T.',
...
export const mockCompletedGigs: CompletedGig[] = [
    {
        ...
        clientId: 'client6',
        clientName: 'TechFlow',
        clientAvatar: 'https://i.pravatar.cc/150?u=techflow',
        amount: 4200,
    ...
    },
    {
        ...
        clientAvatar: 'https://i.pravatar.cc/150?u=gsx',
        amount: 15000,
    ...
    },
    {
        ...
        clientAvatar: 'https://i.pravatar.cc/150?u=fintech',
        amount: 6500,
